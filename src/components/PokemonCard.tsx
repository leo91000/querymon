  ...
  return (
    <Card class="group flex items-center gap-4 p-4">
      <img
        ...
        width={64}
        height={64}
        class="h-16 w-16 shrink-0 rounded-lg bg-gray-100 object-contain ring-1 ring-gray-200"
        loading="lazy"
      />
      <div class="min-w-0 flex-1">
        <div class="flex items-center justify-between">
          <h3 class="truncate text-base font-semibold text-gray-900">#{p.id.toString().padStart(3, '0')} {p.name}</h3>
        </div>
